...
def generate_launch_description():
    ...
    left_arm_gripper_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["left_arm_gripper_controller", "--controller-manager", "/controller_manager"],
    )
    ...
    right_arm_gripper_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["right_arm_gripper_controller", "--controller-manager", "/controller_manager"],
    )
    ...
    return LaunchDescription(
        [
            ...
            left_arm_gripper_controller_spawner,
            right_arm_controller_spawner,
            right_arm_gripper_controller_spawner,
        ]
    )